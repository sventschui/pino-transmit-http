...
module.exports = function useSendBeacon (opts) {
  ...
  if (opts.method && opts.method !== 'POST') {
    console.warn('Tried to use method %s when using sendBeacon. This is not supported!', opts.method)
    return false
  }
  ...
  if (opts.headers) {
    ...
    if (headerNames.length >= 1 &&
      ...
      console.warn('Tried to use custom headers when using sendBeacon. This is not supported!')
      return false
    }
  }
